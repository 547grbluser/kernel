...
static int tvp5150_power(int onoff)//low_reset GPE1_4
{
	...
	s3c_gpio_cfgpin(S5PV210_GPE1(4), S3C_GPIO_OUTPUT);
	s3c_gpio_setpull(S5PV210_GPE1(4), S3C_GPIO_PULL_NONE);
	s3c_gpio_setpin(S5PV210_GPE1(4), 0);
	mdelay(1);
	s3c_gpio_setpin(S5PV210_GPE1(4), 1);
...
//	s3c_gpio_setpin(S5PV210_GPH2(1), 1);
//	gpio_free(S5PV210_GPH2(1));	
	
	return 0;
}

static struct tvp5150_platform_data tvp5150_plat = //include/media/s5k3ba_platform.h
{
	.default_width = 720,//
	.default_height = 288,//
...
static struct ov3640_platform_data ov3640_plat = //include/media/s5k3ba_platform.h
{
	.default_width = 640,
	.default_height = 480,
	.pixelformat = V4L2_PIX_FMT_VYUY,
...
static struct s3c_platform_camera ov3640 = {
	...
	.pixelformat	= V4L2_PIX_FMT_VYUY,
	.srclk_name	= "mout_epll",//"mout_epll",//"mout_mpll", "xusbxti",
	.clk_name	= "sclk_cam0",//"sclk_cam0","sclk_cam",	//arch/arm/mach-s5pv210/clock.c
	.clk_rate	= 20000000,
	.line_length	= 640,////////////////////////
	.width		= 640,
...
static void s3c_mcp2515_init(void)
{
...
{
	.f_osc = 20 * 1000 * 1000,
	.platform_init = s3c_mcp2515_init,
};
...
static struct platform_device *smdkv210_devices[] __initdata = {
	...
	&s3c_device_hsmmc0,
#endif
#if 0//def CONFIG_S3C_DEV_HSMMC1
	&s3c_device_hsmmc1,
#endif
...
#ifdef CONFIG_FB_S3C_LTE43
static struct s3c_platform_fb lte43_fb_data __initdata = {
	.hw_ver	= 0x62,
	.nr_wins = 5,
	.default_win = CONFIG_FB_S3C_DEFAULT_WINDOW,
	.swap = FB_SWAP_WORD | FB_SWAP_HWORD,
...
#elif  defined(CONFIG_FB_S3C_LTE43)
	s3cfb_set_platdata(&lte43_fb_data);
#else
...
void usb_host_phy_init(void)
{
	...
	printk("S3C_UDC_OTG_HPRT = 0x%x",__raw_readl(S3C_UDC_OTG_HPRT)); 
}
